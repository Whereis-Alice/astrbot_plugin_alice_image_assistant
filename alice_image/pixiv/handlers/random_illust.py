...
class RandomIllustHandler:
    def __init__(self, client_wrapper, pixiv_config, context, features=None):
        ...
        self.random_search_service = RandomSearchService(
            ...
            pixiv_config,
            context,
            tag_search_enabled=features.get("random_search", True),
            ranking_enabled=features.get("random_ranking", True),
        )
